...
var sync = activeWin.exports.sync = (options) => {
  if (process.platform === "darwin") {
...
var getOpenWindows = activeWin.exports.getOpenWindows = (options) => {
  if (process.platform === "darwin") {
...
var getOpenWindowsSync = activeWin.exports.getOpenWindowsSync = (options) => {
  if (process.platform === "darwin") {
...
const index = /* @__PURE__ */ getDefaultExportFromCjs(activeWinExports);
